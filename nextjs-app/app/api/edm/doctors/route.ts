...
/**
 * Server-side proxy: GET /api/edm/doctors
 * Forwards request to EDM /doctors endpoint using stored access token.
...
export async function GET(req: Request) {
  try {
    ...
    // Find latest non-revoked EDM auth
    ...
    const url = `${base}/doctors/`; // adjust if endpoint differs
    ...
    console.error("GET /api/edm/doctors error:", err);
